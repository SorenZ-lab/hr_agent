...
async def search_knowledge_base(
    ...
    """
    Hybrid semantic + keyword search over the HRAgent Milvus knowledge base.
    ...
    Args:
        ...
        position_id: Optional position UUID to restrict search scope
