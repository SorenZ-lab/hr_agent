...
import os
# print(sys.path)
hragent_path = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
# print(f'hragent_path-->{hragent_path}')
...
if __name__ == '__main__':
    ...
    log = get_logger("demo")
    # log.info("user.login", user_id="u1", role="candidate")
